...
CREATE TABLE `account` (
  ...
  `server_type` int(11) DEFAULT '0' COMMENT '服务类型',
  PRIMARY KEY (`id`),
...
INSERT INTO `resource` VALUES (1,'计算机','dev.server',1,'Windows','Windows 7',0,22,0,3389,1,'2019-01-16 16:17:00',NULL);
...
-- Dump completed on 2019-01-16 18:42:40
